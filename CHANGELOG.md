...
- 72f9962: Test multi-package Slack notification format
...
- 30956c8: Major v1.0 release with comprehensive API documentation
...
- d102647: **BREAKING CHANGE**: Remove non-standard `writeMappedRange()` API
...
- 85a5bf6: fix(getMappedRange): return ArrayBuffer for WebGPU standard compliance
